...
for (i in 1: nrow(site_inf)) {
  ...
  write(SMout, file = paste('E:/Researchs/Papers/Wheat climate suatiable/SIMOUTS/CSCRP/Baseline/', 
  ...
  for (n in YEAR[2] : max(YEAR)) {
    ...
    ##@@
    system("C:/DSSAT47/DSCSM047.EXE CSCRP047 B DSSBatch.v47")
    ...
    write(SMDATA, file = paste('E:/Researchs/Papers/Wheat climate suatiable/SIMOUTS/CSCRP/Baseline/', 
...
source('E:\\Researchs\\Papers\\Wheat climate suatiable\\DSSATR\\Codes\\CERES-Wheat Batch run dssat-R.R')

source('E:\\Researchs\\Papers\\Wheat climate suatiable\\DSSATR\\Codes\\N-Wheat Batch run dssat-R.R')
